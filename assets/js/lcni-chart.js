document.addEventListener("DOMContentLoaded", async () => {
  ...
  const renderChart = async (container) => {
    ...
    try {
      ...
      const rs1wSeries = rsChart.addLineSeries({ color: "#0f766e", lineWidth: 2 });
      const rs1mSeries = rsChart.addLineSeries({ color: "#0369a1", lineWidth: 2 });
      const rs3mSeries = rsChart.addLineSeries({ color: "#7c2d12", lineWidth: 2 });
