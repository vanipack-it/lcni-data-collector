...
class LCNI_WatchlistShortcode {
    ...
    public function render_watchlist() {
        ...
        $style_attr = sprintf(
            ...
            max(30, min(80, (int) ($styles['head_height'] ?? 40))),
            max(28, min(60, (int) ($styles['dropdown_height'] ?? 34))),
            ...
            max(28, min(60, (int) ($styles['input_height'] ?? 34))),
